	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="ui-block">
					<div class="ui-block-title">
						<img style="cursor: pointer;" class="lemodal_moderation" src="../<?php echo $value2['photo_avatar'];?>" alt="thumb-composition" data-toggle="modal" data-target="#problemos" data-id="<?php echo $value2['id_user'];?>"> <h6 class="title"><?php echo $value2['prenom'];?> <?php echo $value2['nom'];?> </h6>
					</div>
