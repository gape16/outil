					...
					<div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-xs-12 bd">
						<div class="ui-block">
							<div class="birthday-item inline-items">
								...
								<a data-toggle="modal" data-target="#anniversaire" data-emet="<?php echo $value['id_emetteur'];?>" data-id="<?php echo $value['id_user'];?>" class="btn btn-sm bg-blue participer">Participer</a>
							</div>
						</div>
					</div>
					<?php }}?>
