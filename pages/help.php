			...
			<div class="row">
				<div class="col-lg-8 m-auto col-md-8 col-sm-12 col-xs-12">
					<div class="main-header-content">
						<h1>Bienvenue sur le centre d’aide</h1>
						<p>Les réponses à toutes vos questions c’est ici !</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="ui-block">
									...
									<td class="freshness">
										<div class="author-freshness">
											<div class="author-thumb">
												...
												<img src="../<?php echo utf8_encode($last['photo_avatar']);?>" alt="author">
												<?php }?>
											</div>
											<?php if($query_nb_com!=0){?>
											<a href="#" class="h6 title"><?php echo $last['prenom'].' '.$last['nom'];?></a>
											<time class="entry-date updated"><?php echo time_elapsed_string($last['date_commentaire']);?></time>
											<?php }?>
										</div>
									</td>
								</tr>
					...
					<nav aria-label="Page navigation">
						<ul class="pagination justify-content-center">
							<li class="page-item <?php if(!isset($_GET['limite']) || $_GET['limite'] == 1){ echo 'disabled';}?>">
								<?php if(isset($_GET['limite'])){
									...
									?>
									<a class="page-link" href="help.php?limite=<?php echo $limite;?>" tabindex="-1">Précédent</a>
									<?php }else{?>
								...
								<li class="page-item">
									<?php if(isset($_GET['limite'])){
										if($nb_limit-10>=$_GET['limite']){
											$limite=$_GET['limite']+9;
											?>
											<a class="page-link" href="help.php?limite=<?php echo $limite;?>">Suivant</a>
											<?php }}else{?>
											<a class="page-link" href="help.php?limite=<?php echo $$_GET['limite']+10;?>" tabindex="-1">Suivant</a>
											<?php }?>
										</li>
									</ul>
								</nav>
						...
						<script src="../js/confettiKit.js"></script>
