...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<main class="col-xl-9 push-xl-3 col-lg-12 push-lg-0 col-md-12 col-sm-12 col-xs-12">
				...
				<aside class="col-xl-3 pull-xl-9 col-lg-6 pull-lg-0 col-md-6 col-sm-12 col-xs-12">
					<div class="ui-block">
