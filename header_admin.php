    ...
    <div class="control-block">
      ...
      <div class="control-icon more has-items" id="first">
        ...
        if($result['notif_A']==0){
          ...
          $query_notif_code=$bdd->prepare("SELECT description, titre, photo, categorie_code.categorie_code FROM code inner join user on code.id_user = user.id_user inner join categorie_code on code.categorie_code = categorie_code.id_categorie_code WHERE id_code > ? and accept_code = 0 order by id_code DESC");
    ...
    <div class="control-icon more has-items">
      ...
      <div class="more-dropdown more-with-triangle triangle-top-center">
        <div class="ui-block-title ui-block-title-small">
          ...
          <a href="achat_photos_admin.php">Allez aux achats</a>
        </div>
        ...
        <div class="mCustomScrollbar" data-mcs-theme="dark">
          ...
          <?php }else{
            ...
            <li>
              ...
              <div class="notification-event">
                <a href="achat_photos_admin.php" class="h6 notification-friend"><?php echo $value['id_client'];?></a>
      ...
      <a href="achat_photos_admin.php" class="view-all bg-primary">Voir tous les achats de photos</a>
    </div>
  </div>
  <div class="control-icon more has-items">
