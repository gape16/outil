											...
											<div class="card-header" role="tab" id="headingOne-1">
												...
												<h5 class="mb-0 title">
													<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-1" aria-expanded="true" aria-controls="collapseOne">
														...
														<span class="event-status-icon"  data-toggle="modal" data-target="#public-event" data-toggle="tooltip" data-placement="top"   data-original-title="UNCOMPLETED">
												...
												<h5 class="mb-0 title">
													<a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo-1" aria-expanded="true" aria-controls="collapseTwo-1">
														...
														<span class="event-status-icon completed" data-toggle="tooltip" data-placement="top"   data-original-title="COMPLETED">
															<svg class="olymp-checked-calendar-icon"><use xlink:href="icons/icons.svg#olymp-checked-calendar-icon"></use></svg>
														</span>
													</a>
												</h5>
											</div>
											...
											<div class="card-header" role="tab" id="headingThree-1">
												...
												<h5 class="mb-0 title">
													<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree-1" aria-expanded="false" aria-controls="collapseThree">
														...
														<span class="event-status-icon" data-toggle="modal" data-target="#private-event" data-toggle="tooltip" data-placement="top"   data-original-title="UNCOMPLETED">
															<svg class="olymp-calendar-icon"><use xlink:href="icons/icons.svg#olymp-calendar-icon"></use></svg>
														</span>
													</a>
												</h5>
									...
									<ul class="nav nav-tabs fc-right" role="tablist">
										...
										<li class="nav-item">
											<a class="nav-link" data-toggle="tab" href="#week" role="tab">
												<svg class="olymp-week-calendar-icon"><use xlink:href="icons/icons.svg#olymp-week-calendar-icon"></use></svg>
											</a>
										</li>

										<li class="nav-item">
											<a class="nav-link" data-toggle="tab" href="#day" role="tab">
												<svg class="olymp-day-calendar-icon"><use xlink:href="icons/icons.svg#olymp-day-calendar-icon"></use></svg>
											</a>
										</li>
									</ul>
															...
															<div class="card-header" role="tab" id="headingThree">
																...
																<h5 class="mb-0 title">
																	<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
																		...
																		<span class="event-status-icon completed" data-toggle="modal" data-target="#public-event" data-toggle="tooltip" data-placement="top"   data-original-title="UNCOMPLETED">
																			<svg class="olymp-checked-calendar-icon"><use xlink:href="icons/icons.svg#olymp-checked-calendar-icon"></use></svg>
																		</span>
																	</a>
																</h5>
