<div class="fixed-sidebar">
  <div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
    <a href="" class="logo">
      <svg id="Calque_1" data-name="Calque 1" viewBox="0 0 70 70" width="100%" height="100%"><defs><style>.cls-1,.cls-2{fill:#fff;}.cls-1{opacity:0.8;}</style></defs><title>Plan de travail 1</title><polygon class="cls-1" points="7.08 18.82 35 2.64 62.92 18.82 62.92 51.18 35 67.36 7.08 51.18 7.08 18.82"/><polygon class="cls-2" points="7.08 18.82 7.08 51.18 35 67.36 35 35 7.08 18.82"/></svg>
    </a>
      ...
      <ul class="left-menu">
        ...
        <li>
          <a href="veille_admin.php">
            <svg class="olymp-magnifying-glass-icon left-menu-icon" data-toggle="tooltip" data-placement="right"   data-original-title="Accueil"><use xlink:href="icons/icons.svg#olymp-magnifying-glass-icon"></use></svg>
            <span class="left-menu-title">Veille</span>
          </a>
        </li>
        <li>
          <a href="controleur.php">
            <svg class="olymp-star-icon left-menu-icon" data-toggle="tooltip" data-placement="right"   data-original-title="Accueil"><use xlink:href="icons/icons.svg#olymp-star-icon"></use></svg>
            <span class="left-menu-title">Attribution note</span>
          </a>
        </li>
        <li>
          <a href="code.php">
           <svg class="olymp-check-icon left-menu-icon" data-toggle="tooltip" data-placement="right"   data-original-title="Accueil"><use xlink:href="icons/icons.svg#olymp-check-icon"></use></svg>
