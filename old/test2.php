...
if (isset($_SESSION['id_statut'])) {
	...
	<head>
		...
		label:before { top: 100px; }
		label:after { top: 120px; }
...
<body>
	...
	<script>
		$(function(){
			...
			$('.fake_grid').css('height', heightDesktop);
			$('.fake_grid .col').css('height', heightDesktop);
			$('.fake_grid').css('width', widthDesktop);
