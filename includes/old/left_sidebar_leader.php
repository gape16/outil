    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
      ...
      <li>
        <a href="accueil_admin.php" class="js-sidebar-open">
          <svg class="olymp-close-icon left-menu-icon" data-toggle="tooltip" data-placement="right"  data-original-title="Accueil"><use xlink:href="icons/icons.svg#olymp-computer-icon"></use></svg>
        </a>
      </li>
      <li>
        <a href="moderation_user.php">
          <svg class="olymp-newsfeed-icon left-menu-icon" data-toggle="tooltip" data-placement="right"  data-original-title="Modération des utilisateurs"><use xlink:href="icons/icons.svg#olymp-newsfeed-icon"></use></svg>
        </a>
      </li>
      <li>
        <a href="help.php">
          <svg class="olymp-happy-faces-icon left-menu-icon" data-toggle="tooltip" data-placement="right"  data-original-title="Les demandes d'aide" ><use xlink:href="icons/icons.svg#olymp-happy-faces-icon"></use></svg>
        </a>
      </li>
      <li>
      ...
      <li>
        <a href="newsletter.php">
          <svg class="olymp-star-icon left-menu-icon" data-toggle="tooltip" data-placement="right"  data-original-title="Newletter" ><use xlink:href="icons/icons.svg#olymp-star-icon"></use></svg>
        </a>
      </li>
      <li>
        <a href="remontees.php">
          <svg class="olymp-calendar-icon left-menu-icon" data-toggle="tooltip" data-placement="right"  data-original-title="Les remontées" ><use xlink:href="icons/icons.svg#olymp-calendar-icon"></use></svg>
        </a>
      </li>
      <li>
        <a href="birthday.php">
