    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
     ...
     <li>
      <a href="remontees.php">
       <svg class="olymp-cupcake-icon left-menu-icon" data-toggle="tooltip" data-placement="right"  data-original-title="Les remontées" ><use xlink:href="icons/icons.svg#olymp-share-post-icon"></use></svg>
     </a>
   </li>
   <li>
    <a href="stats.php">
