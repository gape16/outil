<div class="fixed-sidebar controleur">
  <div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
      ...
      <li>
        <a href="badges.php">
          <svg class="olymp-badge-icon left-menu-icon" data-toggle="tooltip" data-placement="right"    data-original-title="Les badges"><use xlink:href="icons/icons.svg#olymp-badge-icon"></use></svg>
        </a>
      </li>
      <li>
        <a href="birthday.php">
